...
/// 
/// </summary>
public class PlayerAudio : DefaultAudioChannel
{
	...
	[SerializeField] private AudioSO heavyAttack;
	...
	public void PlayHeavyAttack() => PlayAudioClipRequest(heavyAttack, audioConfiguration, transform.position);
